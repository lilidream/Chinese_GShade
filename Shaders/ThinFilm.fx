...
uniform int BlendingMode <
	ui_label = "混合模式";
	ui_type = "combo";
	ui_items = "正常模式\0相乘\0滤色\0覆盖\0柔光\0";
	ui_category = "混合选项";
> = 2;
...
technique ThinFilm < ui_label = "薄膜(彩虹色)";
ui_tooltip = "应用薄膜干涉（彩虹色）的'全息'效果..."; >
{
	pass
	{
