...
uniform int BlackPoint <
	...
	ui_type = "slider";
	ui_min = 0; ui_max = 255;
	ui_tooltip = "模糊贴图的新黑点。任何比此黑的像素都将变得完全黑。";
> = 60;
uniform int WhitePoint <
	ui_label = "白点";
	ui_type = "slider";
	ui_min = 0; ui_max = 255;
	ui_tooltip = "模糊贴图的新白点。任何比此亮的像素都变得完全白色。";
> = 150;
uniform float MidTonesShift <
	ui_label = "中间调偏移";
	ui_type = "slider";
	ui_min = -1.0; ui_max = 1.0;
	ui_tooltip = "调整模糊贴图的中间调。";
> = -0.84;
uniform float BlendStrength <
	ui_label = "混合强度";
	ui_type = "slider";
	ui_min = 0.00; ui_max = 1.0;
	ui_tooltip = "模糊贴图的不透明度。保持这个值较低，否则图像会变得非常模糊。";
> = 0.07;
...
technique OrtonBloom <ui_label="Orton泛光";>
{
	pass GaussianBlur1
	{
