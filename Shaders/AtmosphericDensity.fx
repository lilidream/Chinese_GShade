...
#define CATEGORY "雾的物理属性" /////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
UI_INT_S (DISTANCE, "密度", "决定了雾所呈现的厚度", 1, 100, 75, 0)
UI_INT_S (HIGHLIGHT_DIST, "高光距离", "控制了多远的高光可以穿透雾", 0, 100, 100, 1)

UI_COLOR (FOG_TINT, "雾的颜色", "", 0.4, 0.45, 0.5, 5)
UI_COMBO (AUTO_COLOR, "雾的颜色模式", "", 3, 1,
    "准确的雾颜色\0"
    "保留场景亮度\0"
    "使用模糊的场景亮度\0")
UI_INT_S (WIDTH, "散光", "控制泛光的宽度。需要使用模式场景亮度", 0, 100, 50, 1)
#undef  CATEGORY ///////////////////////////////////////////////////////////////

#if (ENABLE_MISC_CONTROLS != 0)
#define CATEGORY "杂项控制" ///////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
// TECHNIQUES //////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
TECHNIQUE    (AtmosphericDensity,   "浑浊大气",
             "浑浊大气（Atmospheric Density)是一个伪体积雾着色器，\n"
             "你可以将雾的颜色调至与你的场景相匹配。",
