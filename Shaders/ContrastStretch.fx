...
namespace Contrast 
{
	...
	uniform uint Debug<
		...
		ui_label = "Debug";
		ui_category = "Debug视角";
		ui_items = "无 \0直方图 \0暗曲线输入 \0中间值曲线输入 \0亮曲线输入 \0";
	> = 0;
	...
	technique ContrastStretch<ui_tooltip = "一个基于直方图的对比度拉伸着色器，根据图像内容自适应地调整图像的对比度。\n"
										   "Part of Insane Shaders \n"
										   "By: Lord Of Lunacy\n\n"
										   "CONTRAST_LUT_SIZES correspond as follows: \n"
										   "0 for 256 \n1 for 1024 (default) \n2 for 2048 \n3 for 4096"; ui_label="对比度拉伸";>
	{
#if CONTRAST_COMPUTE != 0
		pass
		{
