...
uniform int iBloomMixmode <
	ui_label = "泛光混合模式";
	ui_type = "combo";
	ui_items = "线性添加\0屏幕添加\0屏幕/变亮/透明度\0变亮\0";
> = 2;
uniform float fBloomThreshold <
	ui_label = "泛光阈值";
	ui_type = "slider";
	ui_min = 0.1; ui_max = 1.0;
	ui_tooltip = "每一个亮度超过此阈值的像素将会泛光";
> = 0.8;
...
uniform float fBloomSaturation <
	...
	ui_tooltip = "泛光饱和度，0.0表示白色泛光，2.0表示非常非常多彩的泛光";
> = 0.8;
uniform float3 fBloomTint <
	ui_label = "泛光色调";
	ui_type = "color";
	ui_tooltip = "使泛光向由RGB组合成的色调偏移";
> = float3(0.7, 0.8, 1.0);
...
uniform float fAnamFlareThreshold <
	...
	ui_type = "slider";
	ui_min = 0.1; ui_max = 1.0;
	ui_tooltip = "任一亮度超过此值的像素将有眩光";
> = 0.9;
uniform float fAnamFlareWideness <
	ui_label = "失真眩光宽度";
	ui_type = "slider";
	ui_min = 1.0; ui_max = 2.5;
	ui_tooltip = "眩光水平宽度。不要设置太高，不然单采样将不可见。";
> = 2.4;
...
uniform float fGodrayDecay <
	...
	ui_tooltip = "衰减速度. 它是对数的, 1.0意味着充满屏幕的无限长圣光";
> = 0.9900;
...
uniform float fGodrayDensity <
	...
	ui_tooltip = "光线密度，越高表示越亮";
> = 1.0;
uniform float fGodrayThreshold <
	ui_label = "圣光阈值";
	ui_type = "slider";
	ui_min = 0.6; ui_max = 1.0;
	ui_tooltip = "产生圣光的最小亮度";
> = 0.9;
uniform int iGodraySamples <
	ui_label = "圣光采样率";
	ui_tooltip = "输入2的n次方的值;有多少采样圣光能到达";
> = 128;
...
uniform float fFlareLuminance <
	...
	ui_tooltip = "亮光通过亮度值(bright pass luminance value)";
> = 0.095;
...
technique BloomAndLensFlares <ui_label="泛光与镜头光效";>
{
	pass BloomPass0
	{
