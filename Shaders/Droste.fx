...
namespace Droste
{
	...
	uniform float X_Offset <
		...
		ui_step = 0.01;
		ui_tooltip = "改变中心的X位置，让它保持为0来获得最佳效果。";
		ui_category = MASKING_M;
	> = 0.0;
	uniform float Y_Offset <
		...
		ui_min = -0.5; ui_max = 0.5;
		ui_step = 0.01;
		ui_tooltip = "改变中心的Y位置，让它保持为0来获得最佳效果。";
		ui_category = MASKING_M;
	> = 0.0;
	uniform int Buffer4 <
		ui_type = "radio"; ui_label = " ";
	...
	technique Droste < ui_tooltip = "弯曲螺旋画面"; ui_label="德罗斯特效果";>
	{
