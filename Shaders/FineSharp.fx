...
uniform float cstr <
	...
	ui_label = "均匀化强度";
	ui_tooltip = "建议根据sstr值对cstr设置: sstr=0->cstr=0, sstr=0.5->cstr=0.1, 1.0->0.6, 2.0->0.9, 2.5->1.00, 3.0->1.09, 3.5->1.15, 4.0->1.19, 8.0->1.249";
> = 0.90;
...
uniform float xrep <
	...
	ui_type = "slider";
	ui_min = 0.00; ui_max = 1.00;
	ui_tooltip = "修复最后锐化的人工痕迹。(-Vit-对原始脚本的补充)";
> = 0.25;
...
technique Mode1 <ui_label="高质量锐化-模式1";>
{
	pass ToYUV
	{
...
technique Mode2 <ui_label="高质量锐化-模式2";>
{
	pass ToYUV
	{
		VertexShader = PostProcessVS;
...
technique Mode3 <ui_label="高质量锐化-模式3";>
{
	pass ToYUV
	{
		VertexShader = PostProcessVS;
