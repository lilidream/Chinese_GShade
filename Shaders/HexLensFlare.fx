...
uniform float3 uColor1 <
	ui_label = "#2";
	ui_category = "颜色";
	ui_tooltip = "默认: R:66 G:151 B:255";
	ui_type = "color";
...
uniform float3 uColor3 <
	ui_label = "#4";
	ui_category = "颜色";
	ui_tooltip = "默认: R:100 G:236 B:255";
	ui_type = "color";
...
technique HexLensFlare <ui_label="六边形镜头光晕";>{
	pass Prepare {
