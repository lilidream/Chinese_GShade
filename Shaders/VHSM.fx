...
// UI VARIABLES ////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
#define CATEGORY "卡带式影相录像机(VCR)设置" ////////////////////////////////////////////////
UI_COMBO (TAPE_SELECT, "选择卡带", "选择你的视频卡带类型", 2, 0,
    "Betamax\0"
    "S-VHS\0"
    "VHS\0"
    "Bad VHS\0"
    "U-Matic\0")
UI_INT_S (CHROMA_SHIFT, "色度偏移", "分割颜色通道。", -100, 100, 50, 5)
UI_COMBO (SHIFT_MODE, "偏移模式", "确定分割通道的颜色组合", 0, 1,
    "红 / 蓝\0"
    "绿 / 洋红\0"
    "黄 / 紫\0")
#undef  CATEGORY
