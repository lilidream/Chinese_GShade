...
technique KNearestNeighbors <ui_label="K临近降噪";>
{
	pass
	{
...
technique NonLocalMeans <ui_label="非局部均值降噪";>
{
	pass
	{
		VertexShader = PostProcessVS;
