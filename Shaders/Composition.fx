...
technique CompositionCenterLines <ui_label="构图线: 中心线";>
{
	pass {
...
technique CompositionThirds <ui_label="构图线: 三分线";>
{
	pass {
		VertexShader = PostProcessVS;
...
technique CompositionFifths <ui_label="构图线: 四分线";>
{
	pass {
		VertexShader = PostProcessVS;
...
technique CompositionGoldenRatio <ui_label="构图线: 黄金比例";>
{
	pass {
		VertexShader = PostProcessVS;
...
technique CompositionDiagonals <ui_label="构图线: 对角线";>
{
	pass {
		VertexShader = PostProcessVS;
