...
uniform int2 display_size <
	ui_type = "input";
	ui_label = "显示大小";
	ui_tooltip = "以像素的虚拟屏幕的大小";
> = int2(320, 240);

uniform float2 pixel_mask_scale <
	ui_type = "input";
	ui_label = "像素遮罩大小";
	ui_tooltip = "重复像素遮罩图像的次数";
> = float2(160, 90);
...
uniform float luma_sharpen <
	...
	ui_max = 4.0;
	ui_label = "亮度锐化";
	ui_tooltip = "为亮度信号应用锐化滤镜";
> = 1.0;

uniform bool EnableTVCurvature <
	ui_label = "开启电视弯曲";
	ui_tooltip = "开启阴极射线管弯曲效果";
> = true;
...
uniform int3 colorbits <
	...
	ui_max = 8;
	ui_label = "颜色比特";
	ui_tooltip = "每个颜色通道的比特数";
> = int3( 8, 8, 8 );

uniform bool EnableRollingFlicker <
	ui_label = "开启滚动闪烁";
	ui_tooltip = "启用 \"闪烁\"效果，模拟电视和摄像机之间的不匹配垂直同步";
> = true;
...
uniform bool EnableBurstCountAnimation <
	ui_label = "开启脉冲计数(brust counter)";
	ui_tooltip = "启用NTSC信号的动画脉冲计数器";
> = true;
