...
uniform uint shadowMask <
	...
	ui_max = 7;
	ui_step = 1;
	ui_label = "CRT遮罩: 1:CGWG, 2-5:Lottes, 6-7:'Trinitron'";
...
technique GuestCRT <ui_label="Guest阴极射线管(老式显示器)";>
{
